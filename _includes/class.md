...
- Location: Clemens 221

- Office Hours: Virtual, by appointment

- **Please communicate as much as possible through Slack, I'm easier to reach there!**
...
|2 | September 6| **Examples 1** | - Rajadesingan et al. (2019). *[Smart, Responsible, and Upper Caste Only: Measuring Caste Attitudes through Large-Scale Analysis of Matrimonial Profiles](https://ashwinrajadesingan.com/files/camera_ready_icwsm.pdf)* <br> - Antoniak et al. (2019). *[Narrative Paths and Negotiation of Power in Birth Stories](https://dl.acm.org/doi/pdf/10.1145/3359190)* | #css_examples_1
|3 | September 13 | **Examples 2** | - Green et al. (2022). *[Online engagement with 2020 election misinformation and turnout in the 2021 Georgia runoff election](https://www.dropbox.com/s/hlmle8wr7nbp0tr/green_2022_online_engagement_with_2020.pdf?dl=0)* <br> - Card et al. (2022). *[Computational analysis of 140 years of US political speeches reveals more positive but increasingly polarized framing of immigration](https://www.pnas.org/doi/10.1073/pnas.2120510119)* | #css_examples_2 |
|4  | September 20 | **Data Feminism** | - D'Ignazio and Klein (2020) *[Data Feminism: Intro](https://data-feminism.mitpress.mit.edu/pub/frfa9szd/release/6)* <br> - Suresh et al. (2022) *[Towards Intersectional Feminist and Participatory ML: A Case Study in Supporting Feminicide Counterdata Collection](https://doi.org/10.1145/3531146.3533132)*|  #data_feminism |
| 5 | September 27 |  **Data Collection** | -   Ernala et al. (2019) *[Methodological gaps in predicting mental health states from social media: Triangulating diagnostic signals](http://www.munmund.net/pubs/CHI19_MethodGaps.pdf)* <br>  - Bozarth and Budak (2022) *[Keyword expansion techniques for mining social movement data on social media](https://epjdatascience.springeropen.com/articles/10.1140/epjds/s13688-022-00343-9)* | #data_collection |
| 6 | October 4 | **Class Cancelled** | ||
| 7 | October 11 | **Data Quality** | - Geiger et al. (2020). *[Garbage In, Garbage Out? Do Machine Learning Application Papers in Social Computing Report Where Human-Labeled Training Data Comes From?](https://arxiv.org/abs/1912.08320)* <br> - Bradley et al. (2022). *[Unrepresentative big surveys significantly overestimated US vaccine uptake](https://www.nature.com/articles/s41586-021-04198-4)* |#data_quality| 
| 8 | October 18 |  **Modern NLP 1** | - Smith. (2019). *[Contextual Word Representations: A Contextual Introduction](http://arxiv.org/abs/1902.06006)* <br> - Levy et al. (2015). *[Improving distributional similarity with lessons learned from word embeddings](https://www.transacl.org/ojs/index.php/tacl/article/view/570/124)* | #modernnlp_1|
|9 | October 25 |  **Modern NLP 2** | -  Devlin et al. (2018). *[BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](https://arxiv.org/abs/1810.04805)* <br>  -  Reimers and Gurevych (2019). *[Sentence-BERT: Sentence Embeddings using Siamese BERT-Networks](http://arxiv.org/abs/1908.10084)*  | #modernnlp_2|
| 10 | November 1 |    **Stance** | - Sen et al. (2020). *[On the Reliability and Validity of Detecting Approval of Political Actors in Tweets](https://www.aclweb.org/anthology/2020.emnlp-main.110.pdf)* <br> - Rashed et al. (2021). *[Embeddings-Based Clustering for Target Specific Stances: The Case of a Polarized Turkey](https://ojs.aaai.org/index.php/ICWSM/article/view/18082)* | #stance|
|11| November 8 | **Bias in NLP 2** | - Blodgett et al. (2020). *[Language (Technology) is Power: A Critical Survey of" Bias" in NLP](https://arxiv.org/pdf/2005.14050.pdf)*. -   De-Arteaga et al. (2019). *[Bias in Bios: A Case Study of Semantic Representation Bias in a High-Stakes Setting](https://arxiv.org/pdf/1901.09451.pdf)* <br>   | #bias2 |
|12| November 15 |  **Bias** | -  Obermeyer et al. (2019). *[Dissecting racial bias in an algorithm used to manage the health of populations](https://science.sciencemag.org/content/366/6464/447)* <br>  -   Stapleton et al. (2022). *[Imagining new futures beyond predictive systems in child welfare: A qualitative study with impacted stakeholders](http://arxiv.org/abs/2205.08928)*  | #big_bias |
|13| November 22|  **Syncing w/ Qualitative Research** | - Eads et al. (2020). *[Separating the wheat from the chaff: A topic- and keyword-based procedure for identifying research-relevant text]()*. <br> - Patton et al. (2020). *[Contextual Analysis of Social Media: The Promise and Challenge of Eliciting Context in Social Media Posts with Natural Language Processing](https://safelab.socialwork.columbia.edu/sites/default/files/2020-03/CASM.pdf)* | #qualitative |
...
The class will be (and is required to be) graded pass/fail.  There are three course components: [readings](#readings), [presentations](#paper-presentations), and [activities](#activity).

- For 1 credit, you must pass the readings component only
- For 2 credits, you must pass the readings and presentation components
- For 3 credits, you must pass the readings, presentation, and activity components.

All students must adhere to the [attendance policy](#attendance-policy) as well.
...
- A [one to two paragraph response on Slack](#reading-responses-on-slack) to one of the two readings
-  A useful [comment](#comments-on-responses-on-slack) on someone else's response
- Attendence at and [active participation](#class-participation) in class, which includes the ability to discuss *both* papers
...
- 12 minute presentation of the paper (guidelines below)
- Lead the discussion of the paper in class)

For students taking the course for three credits, a final pass/fail component of the course is the partner-planned activity, see [activity](#activity).
...
- https://github.com/ryanjgallagher/corex_topic
- https://github.com/bahareharandizade/keyetm
